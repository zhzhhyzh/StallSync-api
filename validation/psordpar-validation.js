...
module.exports = function validatePsordparInput(data, type) {
    ...
    data.psordrap = !isEmpty(data.psmbruid) ? data.psordrap : "N";
    data.psordpap = !isEmpty(data.psmbruid) ? data.psordpap : "N";
    data.psordpre = isEmpty(data.psmbruid) ? data.psordpre : "";
